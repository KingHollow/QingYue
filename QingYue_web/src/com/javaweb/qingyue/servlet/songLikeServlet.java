...
public class songLikeServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RUserSongLikeDao rusd = new RUserSongLikeDao();
            List<Song> songList;
            try {
                songList = rusd.getSongLikeList(user.getId());
            ...
            songList.forEach(s -> {
                ...
                jsonObject.put("singer", s.getSinger());
